...
ENV PHP_EXTRA_CONFIGURE_ARGS --enable-fpm --with-freetype-dir --enable-sockets --enable-zip --with-pcre-regex --with-mysql --with-pdo-mysql --with-mysqli --with-fpm-user=www-data --with-fpm-group=www-data --with-libdir=lib64
##</autogenerated>##
...
# Modify default source list [by zwf]
RUN set -x \
